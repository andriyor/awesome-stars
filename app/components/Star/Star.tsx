...
const Star: FunctionComponent<StarPropTypes> = (props): ReactElement => {
    const { hasError = false, stargazersCount = 0, ...restProps } = props;
    return (
        <svg width={11} height={10} {...restProps}>
            <path
                data-testid="star"
                ...
                fill={numberToColor(stargazersCount, hasError)}
                fillRule="evenodd"
            />
        </svg>
    );
